...
async def process_video(req: VideoRequest):
    ...
    try:
        ...
        summary = await rag.generate_summary(video_id, full_text)
        ...
        raise HTTPException(
            status_code=404, detail="Subtitles are disabled for this video."
        )
    except NoTranscriptFound:
        raise HTTPException(
            status_code=404, detail="No English or Filipino transcript found."
        )
